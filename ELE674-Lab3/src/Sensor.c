...
/* A faire! */
/* Soit une task pour TOUS capteurs OU Soit une tache par capteurs OU une tache instancé au nb capteurs(stratégie Bruno)
 *  -> passage en parametres (sensor struct)*/
...
/* A faire! */
/* recoit un tableau de capteurs SensorTab[]*/
